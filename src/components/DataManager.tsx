            ...
            <div className="space-y-2">
              <div>
                ...
                <DateTimePicker
                  ...
                  onChange={(date) => {
                    console.log('[DatePicker] From changed:', date?.toISOString())
                    setFilterDateFrom(date)
                  }}
                  onClose={() => {
                    console.log('[DatePicker] From closed, value:', filterDateFrom?.toISOString())
                  }}
                  slotProps={{
                    textField: {
                      size: 'small',
              ...
              <div>
                ...
                <DateTimePicker
                  value={filterDateTo}
                  onChange={(date) => {
                    console.log('[DatePicker] To changed:', date?.toISOString())
                    setFilterDateTo(date)
                  }}
                  onClose={() => {
                    console.log('[DatePicker] To closed, value:', filterDateTo?.toISOString())
                  }}
                  slotProps={{
                    textField: {
                      size: 'small',
